...
var recommendations = function (_commonService) {
    _inherits(recommendations, _commonService);
    ...
    */
    ...
    recommendations.prototype.cancelOperation = function cancelOperation(_ref2) {
        var _this2 = this;
        ...
        }).then(function (operationIdUrl) {
            return _this2.getOperationIdFromUrl(operationIdUrl);
        });
    };
    ...
    @returns {Promise.<object>}
       */
    recommendations.prototype.createBusinessRule = function createBusinessRule(_ref3) {
        ...
        var operation = {
            ...
            "headers": [{
                ...
                "options": ["application/json", "text/json", "application/xml", "text/xml", "application/x-www-form-urlencoded"],
                "required": false,
                "typeName": "string"
            }]
        };
    ...
    @returns {Promise.<object>}
    */
    recommendations.prototype.createAModel = function createAModel(_ref4) {
    ...
    @returns {Promise.<string>}  ID of operation
    */
    recommendations.prototype.createOrTriggerABuild = function createOrTriggerABuild(_ref5) {
        var _this3 = this;
        ...
        return this.makeRequest({
            ...
            return _this3.getOperationIdFromUrl(operationIdUrl);
        });
    };
     ...
     * @returns {Promise.<object>}
    */
    recommendations.prototype.deleteAllBusinessRules = function deleteAllBusinessRules(_ref6) {
     ...
     * @returns {Promise.<object>}
    */
    recommendations.prototype.deleteAllUsageFiles = function deleteAllUsageFiles(_ref7) {
    ...
    @returns {Promise.<object>}
    */
    recommendations.prototype.deleteABuild = function deleteABuild(_ref8) {
     ...
     * @returns {Promise.<object>}
       */
    recommendations.prototype.deleteBusinessRule = function deleteBusinessRule(_ref9) {
    ...
    The request body should contain one line per item that must be deleted. The first entry per line should contain the item id to be deleted. This allows you to either pass just the item id, or in the same format that is used to upload items to the catalog.
     @returns {Promise.<object>}
     */
    recommendations.prototype.deleteCatalogItems = function deleteCatalogItems(_ref10) {
    ...
    @returns {Promise.<object>}
    */
    recommendations.prototype.deleteAModel = function deleteAModel(_ref11) {
     ...
     * @returns {Promise.<object>}
    */
    recommendations.prototype.deleteUsageFile = function deleteUsageFile(_ref12) {
     ...
     * @returns {Promise.<object>}
    */
    recommendations.prototype.downloadUsageFile = function downloadUsageFile(_ref13) {
     ...
     * @returns {Promise.<object>}
    */
    recommendations.prototype.getAllBatchJobs = function getAllBatchJobs(_ref14) {
     ...
     * @returns {Promise.<object>}
    */
    recommendations.prototype.getAllBuilds = function getAllBuilds(_ref15) {
     ...
     * @returns {Promise.<object>}
    */
    recommendations.prototype.getAllBusinessRules = function getAllBusinessRules(_ref16) {
     ...
     * @returns {Promise.<object>}
    */
    recommendations.prototype.getAllCatalogItems = function getAllCatalogItems(_ref17) {
     ...
     * @returns {Promise.<object>}
    */
    recommendations.prototype.getAllModels = function getAllModels() {
    ...
    Example Parameters: {
        ...
        @returns {Promise.<object>}
    */
    recommendations.prototype.getBuildById = function getBuildById(_ref18) {
     ...
     * @returns {Promise.<object>}
    */
    recommendations.prototype.getBuildDataStatistics = function getBuildDataStatistics(_ref19) {
     ...
     * Retrieves the build metrics for the given build of the model. This will return metrics such as precision and diversity for the build. As part of the precision and diversity metrics evaluation, the system finds a sample of users, and then the transactions for those users are split into two groups: the training dataset and the test dataset. In order to get metrics, you should have set the enableModelingInsights parameter to true at build time.
        ...
        @returns {Promise.<object>}
    */
    recommendations.prototype.getBuildMetrics = function getBuildMetrics(_ref20) {
     ...
     * @returns {Promise.<object>}
    */
    recommendations.prototype.getBusinessRule = function getBusinessRule(_ref21) {
    ...
    Empty recommendations may be returned if none of the items are in the catalog or if the trained model did not have sufficient data to provide recommendations for the items.
     ...
     @returns {Promise.<object>}
    */
    recommendations.prototype.getItemToItemRecommendations = function getItemToItemRecommendations(_ref22) {
    ...
    Example Parameters: {
        ...
        @returns {Promise.<object>}
    */
    recommendations.prototype.getAModelById = function getAModelById(_ref23) {
     ...
     * @returns {Promise.<object>}
    */
    recommendations.prototype.getModelFeatures = function getModelFeatures(_ref24) {
     ...
     * Retrieves the status of an operation given the operation ID. You will need to use this API to track the status of a build operation, for instance.
        ...
        @returns {Promise.<object>}
    */
    recommendations.prototype.getOperationStatus = function getOperationStatus(_ref25) {
     ...
     * Search for catalog items.
        ...
        @returns {Promise.<object>}
    */
    recommendations.prototype.getSpecificCatalogItemsBySearchTerm = function getSpecificCatalogItemsBySearchTerm(_ref26) {
        var parameters = _ref26.parameters;
     ...
     * @returns {Promise.<object>}
    */
    recommendations.prototype.getUsageStatisticsForABuild = function getUsageStatisticsForABuild(_ref27) {
        var parameters = _ref27.parameters;
     ...
     * @returns {Promise.<object>}
    */
    recommendations.prototype.getUsageStatisticsForAModel = function getUsageStatisticsForAModel(_ref28) {
        var parameters = _ref28.parameters;
    ...
    @returns {Promise.<object>}
    */
    recommendations.prototype.getUserToItemRecommendations = function getUserToItemRecommendations(_ref29) {
        var parameters = _ref29.parameters;
     ...
     * @returns {Promise.<object>}
    */
    recommendations.prototype.listUsageFiles = function listUsageFiles(_ref30) {
        var parameters = _ref30.parameters;
    ...
    Once the operation is started, you need to wait for it to complete before you can gather the results of the operation. The response from the creation call with contain a header called Operation-Location. You can use this operation location to query the status of the batch processing. See the "Get operation status" API.
     @returns {Promise.<string>}  ID of operation
    */
    recommendations.prototype.startBatchJob = function startBatchJob(_ref31) {
        var _this4 = this;

        var headers = _ref31.headers,
            body = _ref31.body;
        ...
        return this.makeRequest({
            ...
            return _this4.getOperationIdFromUrl(operationIdUrl);
        });
    };
     ...
     * Updates a set of items in the catalog.
        ...
        The format used is the same as the format for uploading catalog files
         @returns {Promise.<object>}
    */
    recommendations.prototype.updateCatalogItems = function updateCatalogItems(_ref32) {
        var parameters = _ref32.parameters,
            body = _ref32.body;
     ...
     * Allows you to update the description or the active build for a model.
     ...
     @returns {Promise.<object>}
    */
    recommendations.prototype.updateModel = function updateModel(_ref33) {
        var parameters = _ref33.parameters,
     ...
     * Once you have created a model, you will need to upload catalog data and usage data to it before you can train the system and create a build. The catalog data contains information about the items you are offering to your customer.
     ...
     @returns {Promise.<object>}
    */
    recommendations.prototype.uploadACatalogFileToAModel = function uploadACatalogFileToAModel(_ref34) {
        var parameters = _ref34.parameters,
            body = _ref34.body;
     ...
     * @returns {Promise.<object>}
    */
    recommendations.prototype.uploadUsageEvent = function uploadUsageEvent(_ref35) {
        var parameters = _ref35.parameters,
    ...
    <User Id>,<Item Id>,<Time>,[<Event type>]
     @returns {Promise.<object>}
    */
    recommendations.prototype.uploadAUsageFileToAModel = function uploadAUsageFileToAModel(_ref36) {
        var parameters = _ref36.parameters,
            body = _ref36.body;
