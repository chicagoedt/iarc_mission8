...
var academicKnowledge = function (_commonService) {
    _inherits(academicKnowledge, _commonService);
     ...
     */
    function academicKnowledge(_ref) {
        var apiKey = _ref.apiKey,
            endpoint = _ref.endpoint;

        _classCallCheck(this, academicKnowledge);
    ...
    academicKnowledge.prototype.calcHistogram = function calcHistogram(_ref2) {
     ...
     * @returns {Promise.<object>}
     */
    academicKnowledge.prototype.calcHistogramPost = function calcHistogramPost(_ref3) {
        var body = _ref3.body;
     ...
     * @returns {Promise.<object>}
     */
    academicKnowledge.prototype.evaluate = function evaluate(_ref4) {
     ...
     * @returns {Promise.<object>}
     */
    academicKnowledge.prototype.evaluatePost = function evaluatePost(_ref5) {
        var body = _ref5.body;
     ...
     * @returns {Promise.<object>}
     */
    academicKnowledge.prototype.graphSearch = function graphSearch(_ref6) {
     ...
     * @returns {Promise.<object>}
     */
    academicKnowledge.prototype.interpret = function interpret(_ref7) {
     ...
     * @returns {Promise.<object>}
     */
    academicKnowledge.prototype.interpretPost = function interpretPost(_ref8) {
        var body = _ref8.body;
     ...
     * @returns {Promise.<object>}
     */
    academicKnowledge.prototype.getSimilarity = function getSimilarity(_ref9) {
     ...
     * @returns {Promise.<object>}
     */
    academicKnowledge.prototype.postSimilarity = function postSimilarity(_ref10) {
