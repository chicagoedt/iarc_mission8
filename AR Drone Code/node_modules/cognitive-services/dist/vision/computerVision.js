...
var computerVision = function (_commonService) {
    _inherits(computerVision, _commonService);
    ...
    */
    ...
    computerVision.prototype.analyzeImage = function analyzeImage(_ref2) {
        ...
        var operation = {
            ...
            "headers": [{
                ...
                "options": ["application/json", "application/octet-stream", "multipart/form-data"],
                "required": false,
                "typeName": "string"
            }],
            "parameters": [{
     ...
     * Generates a description of an image in human readable language with complete sentences. The description is based on a collection of content tags, which are also returned by the operation. More than one description can be generated for each image. Descriptions are ordered by their confidence score. All descriptions are in English. 
     ...
     A successful response will be returned in JSON. If the request failed, the response will contain an error code and a message to help understand what went wrong.
    */
    computerVision.prototype.describeImage = function describeImage(_ref3) {
    ...
    */
    computerVision.prototype.getThumbnail = function getThumbnail(_ref4) {
     ...
     * Returns the list of domain-specific models that are supported by the Computer Vision API. Currently, the API supports following domain-specific models: celebrity recognizer, landmark recognizer. 
     A successful response will be returned in JSON. If the request failed, the response will contain an error code and a message to help understand what went wrong.
    */
    computerVision.prototype.listDomainSpecificModels = function listDomainSpecificModels() {
    ...
    */
    computerVision.prototype.ocr = function ocr(_ref5) {
        ...
        var operation = {
            ...
            "parameters": [{
                ...
                "value": "unk",
                "options": ["unk", "zh-Hans", "zh-Hant", "cs", "da", "nl", "en", "fi", "fr", "de", "el", "hu", "it", "ja", "ko", "nb", "pl", "pt", "ru", "es", "sv", "tr", "ar", "ro", "sr-Cyrl", "sr-Latn", "sk"],
                "required": false,
                "type": "queryStringParam",
                "typeName": "string"
            }, {
    ...
    */
    computerVision.prototype.recognizeDomainSpecificContent = function recognizeDomainSpecificContent(_ref6) {
    ...
    - Specifying an image URL. 
      * A successful response will be returned in JSON. If the request failed, the response will contain an error code and a message to help understand what went wrong.
    */
    computerVision.prototype.tagImage = function tagImage(_ref7) {
    ...
    */
    computerVision.prototype.getHandwrittenTextOperationResult = function getHandwrittenTextOperationResult(_ref8) {
    ...
    */
    computerVision.prototype.recognizeHandwrittenText = function recognizeHandwrittenText(_ref9) {
        var _this2 = this;
